(function () {
    ...
    app.factory('userService', ['$http', 'localizedWebAPIService',
        function ($http, localizedWebAPIService) {
            ...
            var _changeSubscribeRequestState = function (requestStateId) {
                return $http.post(localizedWebAPIService.get("User/ChangeSubscribeRequestState"), JSON.stringify({requestStateId: requestStateId})).then(function (results) {
                    return results;
                });
            };
