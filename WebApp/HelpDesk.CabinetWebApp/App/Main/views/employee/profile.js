(function () {
    ...
    var controllerId = 'app.views.employee.profile';
    app.controller(controllerId, [
        '$rootScope', 'employeeService', 'modalService',
        function ($rootScope, employeeService, modalService) {
            ...
            vm.save = function () {
                ...
                employeeService.save(vm.employee).then(function (results) {
                    ...
                    if (results.data.success === false) {
                        ...
                        init();
                        $rootScope.$broadcast("employeeChangedSuccess", { fio: vm.employee.FM + " " + vm.employee.IM + " " + vm.employee.OT });
                    }
                }, function (error) {
            ...
            var employee = {};
            var init = function () {
                employeeService.get().then(function (results) {
